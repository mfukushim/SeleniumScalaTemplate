...
class GoogleSearchSpec extends FlatSpec with WebBrowser {
  ...
  "Google検索" should "検索出来る" in {
    ...
    textField(xpath("/html/body/div/div[3]/form/div[2]/div/div[1]/div/div[1]/input")).value = "akibakokoubou"

    submit()

    //  検索結果ができあがるまで待ち
    val wait: WebDriverWait = new WebDriverWait(webDriver, 10)
    wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[6]/div[3]/div[10]/div[1]/div[2]/div/div[2]/div[2]/div/div/div/div[1]/div/div[1]/div/div/div[1]/a/h3")))
